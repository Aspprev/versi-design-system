            ...
            >
              ...
              {control.type === "search" ? (
                <input
                  ...
                  className="field-keyboard-focus-ring h-10 rounded border border-field-border-default bg-field-surface px-3 text-sm text-field-content outline-none placeholder:text-field-placeholder focus:border-field-border-active"
                />
              ) : (
                <div className="flex flex-col gap-1">
                  {control.optionList?.map((option, index) => (
                    ...
                    >
                      ...
                      <span
                        aria-hidden="true"
                        className="radio-control-proxy mt-1"
                      />
