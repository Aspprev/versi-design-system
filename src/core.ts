/**
 * Componentes sem dependências opcionais de formulários, overlays ou
 * visualizações. A entrada raiz continua exportando tudo por compatibilidade;
 * consumidores novos podem importar esta camada para manter o núcleo leve.
 */
